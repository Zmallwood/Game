...
namespace Zmallwood {
  ...
  void Mesh::Draw(void) {
    ...
    for (unsigned int i = 0; i < textures.size(); i++) {
      ...
      // i); and finally bind the texture
  ...
  void Mesh::SetupMesh(void) {
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(GLMVertex),
                          (void *)0);
    // vertex normals
    ...
    glVertexAttribPointer(3, 3, GL_FLOAT, GL_FALSE, sizeof(GLMVertex),
                          (void *)offsetof(GLMVertex, tangent));
    // vertex bitangent
    glEnableVertexAttribArray(4);
    glVertexAttribPointer(4, 3, GL_FLOAT, GL_FALSE, sizeof(GLMVertex),
                          (void *)offsetof(GLMVertex, bitangent));
    // ids
    glEnableVertexAttribArray(5);
    glVertexAttribIPointer(5, 4, GL_INT, sizeof(GLMVertex),
                           (void *)offsetof(GLMVertex, m_boneIDs));
    // weights
    glEnableVertexAttribArray(6);
    glVertexAttribPointer(6, 4, GL_FLOAT, GL_FALSE, sizeof(GLMVertex),
